...
|---------|------|----------------|
| `PPH_Open` | `shift_1` | `PPH_Open_t-1` |
| `PPH_High` | `shift_1` | `PPH_High_t-1` |
| `PPH_Low` | `shift_1` | `PPH_Low_t-1` |
| `PPH_Close` | `shift_1` | `PPH_Close_t-1` |
| `PPH_Volume` | `shift_1` | `PPH_Volume_t-1` |
| `XPH_Open` | `shift_1` | `XPH_Open_t-1` |
| `XPH_High` | `shift_1` | `XPH_High_t-1` |
| `XPH_Low` | `shift_1` | `XPH_Low_t-1` |
| `XPH_Close` | `shift_1` | `XPH_Close_t-1` |
| `XPH_Volume` | `shift_1` | `XPH_Volume_t-1` |
